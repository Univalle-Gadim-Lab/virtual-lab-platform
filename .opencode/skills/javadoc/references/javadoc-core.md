...
This document defines core JavaDoc documentation standards for projects, ensuring consistency, completeness, and maintainability across the codebase.
...
Use supported HTML tags directly; do not replace < or > with HTML entities.
...
Use this consolidated checklist when verifying JavaDoc completeness across a class, package, or project.

### Completeness
- [ ] All public/protected classes and interfaces documented
- [ ] All public/protected methods documented
- [ ] All public/protected fields documented
- [ ] All enum constants documented with purpose
- [ ] Package-info.java files present for all packages
...
- [ ] All parameters described with validation rules
- [ ] Return values documented with guarantees and null handling
...
- [ ] All {@link} references valid and resolve correctly
- [ ] HTML tags properly closed
- [ ] Code formatted with {@code} or <pre><code>
- [ ] Paragraphs separated with <p> tags
- [ ] Lists use proper <ul>/<ol> tags

### Context-Specific (see reference files for details)
- [ ] Class/Interface: Thread-safety, usage examples, inheritance
- [ ] Methods: Override behavior, builder/factory patterns, generic methods
- [ ] Code Examples: Complete, compilable, show error handling

For detailed context-specific checklists, see:
- `javadoc-class-documentation.md` - Class/Interface/Enum/Annotation checklist
- `javadoc-method-documentation.md` - Method/Field/Constructor checklist
- `javadoc-code-examples.md` - Code formatting and example checklist
